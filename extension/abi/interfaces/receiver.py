...
class ReceiverInterface(Interface):
    ...
    def Create(
        ...
        *,
        ...
        How marks are made is a technique, not a receiver setting. A host that paints with dabs and
        needs to bound them opens its receiver through `RasterBrushes` instead, which takes the same
        arguments plus that bound.
